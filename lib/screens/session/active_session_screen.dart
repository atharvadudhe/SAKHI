...
class _ActiveSessionScreenState extends ConsumerState<ActiveSessionScreen> {
  ...
  Future<void> _handleDuressCancellation(String sessionId, String uid) async {
    try {
  ...
  Future<void> _triggerSOS(String sessionId) async {
    await ref.read(sessionControllerProvider.notifier).triggerSOS(sessionId);
